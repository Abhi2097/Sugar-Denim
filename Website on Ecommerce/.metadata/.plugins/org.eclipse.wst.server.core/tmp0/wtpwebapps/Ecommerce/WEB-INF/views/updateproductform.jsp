...
<body>
 ...
 <form:form modelAttribute="product" action="${pageContext.request.contextPath}/admin/updateproduct" method="post" enctype="multipart/form-data" style="border:1px solid #ccc">
